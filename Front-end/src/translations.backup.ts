...
export const translations: Record<string, Translations> = {
  ...
  games: {
    ...
    tutorials: {
      ...
      description: 'Learn advanced techniques and strategies with our interactive tutorials and training modes.',
      features: {
  ...
  fr: {
    ...
    games: {
      title: 'Jeux',
      subtitle: 'Choisissez votre bataille',
      back: 'Retour',
      oneVsOne: {
        title: '1v1 Duel',
        subtitle: 'Affrontez votre adversaire',
        description: 'Défiez un ami ou un joueur aléatoire dans un match de ping pong intense. Jeux rapides, action immédiate !',
        features: {
          instant: 'Appariement instantané',
          ranked: 'Jeu compétitif classé',
          skill: 'Appariement par compétence'
        },
      ...
      ai: {
        ...
        features: {
          ...
          practice: 'Idéal pour s\'entraîner',
          skills: 'Améliorez vos compétences'
        },
        playNow: 'JOUER CONTRE L\'IA'
      },
      tournaments: {
        title: 'TOURNOIS',
        ...
        features: {
          strategic: 'Système de tournoi stratégique',
          prestige: 'Récompenses prestigieuses',
      ...
      tutorials: {
        title: 'TUTORIELS',
        subtitle: 'Maîtrisez le jeu',
        description: 'Apprenez des techniques avancées et des stratégies avec nos tutoriels interactifs et modes d\'entraînement.',
        features: {
          basics: 'Apprenez les bases',
          advanced: 'Techniques avancées',
          practice: 'Mode entraînement'
        },
        startLearning: 'COMMENCER',
        viewAll: 'VOIR LES TUTORIELS'
      },
      stats: {
  ...
  es: {
    ...
    games: {
      title: 'Juegos',
      subtitle: 'Elige tu batalla',
      back: 'Atrás',
      oneVsOne: {
        title: '1v1 Duelo',
        subtitle: 'Enfréntate a tu oponente',
        description: 'Desafía a un amigo o a un jugador aleatorio a un intenso partido de ping pong uno contra uno. ¡Partidas rápidas, acción al instante!',
        features: {
          instant: 'Emparejamiento instantáneo',
          ranked: 'Juego competitivo clasificado',
      ...
      ai: {
        title: 'Desafío IA',
        subtitle: 'Enfréntate a la máquina',
        description: 'Pon a prueba tus habilidades contra nuestros avanzados oponentes de IA con diferentes niveles de dificultad.',
        features: {
          adaptive: 'Dificultad adaptativa',
          practice: 'Perfecto para practicar',
          skills: 'Mejora tus habilidades'
        },
        playNow: 'JUGAR CONTRA LA IA'
      },
      tournaments: {
        title: 'TORNEOS',
        subtitle: 'La competencia de élite te espera',
        description: 'Únete a torneos exclusivos y compite contra los mejores jugadores por la gloria definitiva.',
        features: {
          strategic: 'Sistema de torneo estratégico',
          prestige: 'Recompensas de prestigio',
          competition: 'Competencia de élite'
        },
      ...
      tutorials: {
        ...
        description: 'Aprende técnicas avanzadas y estrategias con nuestros tutoriales interactivos y modos de entrenamiento.',
        features: {
        ...
        viewAll: 'VER TUTORIALES'
      },
      stats: {
        activePlayers: 'JUGADORES ACTIVOS',
        ongoingMatches: 'PARTIDOS EN CURSO',
        tournaments: 'TORNEOS'
      },
      loginRequired: {
